...
const ICONS: { [key: string]: React.ReactNode } = {
  ...
  google: <path d="M21.4,12.2c0-0.8-0.1-1.5-0.2-2.2H12v4.2h5.3c-0.2,1.4-1,2.5-2.4,3.3v2.7h3.5C20.4,18.1,21.4,15.4,21.4,12.2z" fill="#4285F4" /><path d="M12,22c2.8,0,5.1-0.9,6.8-2.5l-3.5-2.7c-0.9,0.6-2.1,1-3.3,1c-2.5,0-4.7-1.7-5.5-4H2.9v2.8C4.6,19.9,8,22,12,22z" fill="#34A853" /><path d="M6.5,13.8c-0.2-0.6-0.3-1.2-0.3-1.8s0.1-1.2,0.3-1.8V7.4H2.9C2.3,8.6,2,10.3,2,12s0.3,3.4,0.9,4.6L6.5,13.8z" fill="#FBBC05" /><path d="M12,6.2c1.5,0,2.9,0.5,3.9,1.5l3.1-3.1C17.1,2.8,14.8,2,12,2C8,2,4.6,4.1,2.9,7.4l3.6,2.8C7.3,7.9,9.5,6.2,12,6.2z" fill="#EA4335" />,
